...
public class MazeFour {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new JEasyFrame(dc, "Maze 4", true).center();
        getMaze();
        MazeFour.getMaze();
    }

    public static OldMaze getMaze() {
        return new OldMaze(maze, w, h, xx, yy,4);
    }
...
//    }
    ...
    static int w = 114;
    static int h = 130;
    static int[] xx = { 7, 15, 19, 27, 39, 51, 63, 75, 87, 95, 99, 107 };
    static int[] yy = { 9, 21, 25, 37, 49, 57, 61, 69, 73, 77, 85, 97, 109, 121 };
