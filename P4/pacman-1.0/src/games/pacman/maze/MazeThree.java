...
public class MazeThree {
    ...
    public static void main(String[] args) throws Exception {
        ...
        new JEasyFrame(dc, "Maze 3", true).center();
        getMaze();
        MazeThree.getMaze();
    }

    public static OldMaze getMaze() {
        return new OldMaze(maze, w, h, xx, yy,3);
    }
...
//    static int[] yy = { 9, 21, 32, 37, 42, 49, 55, 63, 67, 73, 85, 97, 109, 121 };
    ...
    static int[] xx = { 7, 15, 19, 27, 31, 39, 51, 63, 75, 83, 87, 95, 99, 107 };
    static int[] yy = { 9, 21, 29, 37, 41, 49, 61, 73, 85, 97, 109, 121 };
