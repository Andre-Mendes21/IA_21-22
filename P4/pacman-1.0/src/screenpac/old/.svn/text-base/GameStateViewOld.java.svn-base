...
public class GameStateViewOld extends JComponent implements Constants {
    ...
    public static void main(String[] args) throws Exception {
        ...
        gs.reset();
        GameStateViewOld gsv = new GameStateViewOld(gs);
...
//        }
    ...
    public static GameStateViewOld test(GameStateSetter gs) {
        GameStateViewOld gsv = new GameStateViewOld(gs);
        JEasyFrame fr = new JEasyFrame(gsv, "Game State", true);
        return gsv;
    }
...
//    }
    ...
    public GameStateViewOld(GameState gs) {
        this.gs = gs;
        mv = new MapView(gs);
    }
